...
@section('sidebar')
    <div class="navbar-vertical-content">
        <ul class="navbar-nav nav nav-pills flex-column" id="navbarVerticalNav" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="studentDetails-tab" data-bs-toggle="tab" href="#studentDetails" role="tab"
                    aria-controls="studentDetails" aria-selected="false">
                                    ...
                                    <div class="d-flex">
                                        <div class="d-flex align-items-end me-3"><label
                                            ...
                                            <div class="form-check form-switch min-h-auto mb-0"><input
                                                    class="form-check-input" id="progress" type="checkbox"
                                                    checked="" data-gantt-progress="data-gantt-progress" /></div>
                                        </div>
                            ...
                            <table class="table table-sm fs-9 mb-0">
                                ...
                                <tbody class="list" id="customers-table-body">
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="student-record align-middle white-space-nowrap text-body-tertiary pe-7">
                                            <button class="btn btn-primary me-1 mb-1" type="button">VIEW</button>
                                        </td>
