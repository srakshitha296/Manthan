                ...
                <table class="table fs-9 mb-0 border-top border-translucent">
                    <thead>
                        <tr>
                            <th class="sort white-space-nowrap align-middle ps-0" scope="col"
                                data-sort="activityTitle" style="width:30%;">TITLE</th>
                            ...
                            <th class="sort align-middle ps-3" scope="col" data-sort="end" style="width:15%;">END
                                DATE</th>
                            <th class="sort align-middle" scope="col" data-sort="statuses"
                    ...
                    <tbody class="list" id="project-list-table-body">
                        <tr class="position-static">
                            <td class="align-middle time white-space-nowrap ps-0 activityTitle py-4"><a
                                    class="fw-bold fs-8" href="#">Helping local schools to get good results</a>
                            </td>
                        ...
                        <tr class="position-static">
                            <td class="align-middle time white-space-nowrap ps-0 activityTitle py-4"><a
                                    class="fw-bold fs-8" href="#">Skill rural population</a>
                            </td>
