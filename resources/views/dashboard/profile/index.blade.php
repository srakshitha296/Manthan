                    ...
                    <div class="card h-100 h-xxl-auto">
                        <div class="card-body d-flex flex-column justify-content-between pb-3">
                            <div class="row align-items-center g-5 mb-3 text-center text-sm-start">
                                ...
                                <div class="col-12 col-sm-auto flex-1">
                                    <h3>Ansolo Lazinatov</h3>
                                    <p class="text-body-secondary">A J Institute of Engineering and
                                        Technology,
                                        Mangaluru </p>
                                    <div><a class="me-2" href="#!"><span
                                                class="fab fa-linkedin-in text-body-quaternary text-opacity-75 text-primary-hover"></span></a><a
                            ...
                            <div class="d-flex flex-between-center border-top border-dashed pt-4">
                                <div>
                                    <h6>DESIGNATION</h6>
                                    <p class="fs-9 text-body-secondary mb-0">Assistant Professor</p>
                                </div>
                                <div>
                                    <h6>QUALIFICATION</h6>
                                    <p class="fs-9 text-body-secondary mb-0">B.Tech, M.Tech, PhD</p>
                                </div>
                                <div>
                                    <h6>SPECIALIZATION</h6>
                                    <p class="fs-9 text-body-secondary mb-0">Cyber Security</p>
                                </div>
                ...
                <div class="col-12 col-md-5 col-xxl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="text-body-secondary">Address</h5>
                            <p class="text-body-secondary">Shatinon Mekalan<br />Vancouver, British
                                Columbia<br />Canada
                            </p>
                            <div class="mb-3">
                                <h5 class="text-body-secondary">Email</h5><a
