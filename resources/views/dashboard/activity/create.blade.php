        ...
        <form class="row g-3 mb-6">
            <div class="col-sm-6 col-md-8">
                <div class="form-floating"><select class="form-select" id="floatingSelectTask">
                        <option selected="selected" value="1">Helping Local schools to get good
                            education
                        </option>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="flatpickr-input-container">
                    <div class="form-floating"><input class="form-control datetimepicker" id="floatingInputStartDate"
                            ...
                            class="ps-3" for="floatingInputStartDate">Start date</label><span
            ...
            <div class="col-sm-6 col-md-4">
                <div class="flatpickr-input-container">
                    <div class="form-floating"><input class="form-control datetimepicker" id="floatingInputEndDate"
                            type="text" placeholder="end" data-options='{"disableMobile":true}' /><label class="ps-3"
                            for="floatingInputend">End Date</label><span
            ...
            <div class="col-12 gy-6">
                <div class="form-floating">
                    <textarea class="form-control" id="floatingProjectOverview" placeholder="Leave a comment here"
                        style="height: 100px"></textarea><label for="floatingProjectOverview">Activity overview</label>
                </div>
            </div>
            ...
            <div class="col-12 gy-6">
                <div class="row g-3 justify-content-end">
                    <div class="col-auto"><button class="btn btn-phoenix-primary px-5">Cancel</button>
                    </div>
                    <div class="col-auto"><button class="btn btn-primary px-5 px-sm-15">Submit</button>
                    </div>
                </div>
            </div>
        </form>
