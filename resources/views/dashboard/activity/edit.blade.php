    ...
    <div class="col-xl-12">
        ...
        <form class="row g-3 mb-6">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="flatpickr-input-container">
                    <div class="form-floating"><input class="form-control datetimepicker"
                            id="floatingInputEndDate" type="text" placeholder="end"
                            data-options='{"disableMobile":true}' /><label class="ps-3"
            ...
            <div class="col-12 gy-6">
                <div class="form-floating">
                    <textarea class="form-control" id="floatingProjectOverview"
                        ...
                        for="floatingProjectOverview">Activity overview</label>
                </div>
            </div>
            ...
            <div class="col-12 gy-6">
                <div class="row g-3 justify-content-end">
                    ...
                    <div class="col-auto"><button class="btn btn-primary px-5 px-sm-15">Update</button>
                    </div>
                </div>
            </div>
        </form>
