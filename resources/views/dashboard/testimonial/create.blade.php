        ...
        <div class="row justify-content-xl-between">
            ...
            <div class="col-12 gy-6">
                <div class="row g-3 justify-content-end">
                    <div class="col-auto"><a href="my_testimonial.html"><button class="btn btn-phoenix-primary px-5"
                            >Cancel</button></a>
                    </div>
                    <div class="col-auto"><button class="btn btn-primary px-5 px-sm-15">Add</button>
                    </div>
                </div>
            </div>
        </div>
