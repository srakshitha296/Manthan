        ...
        <div class="row gy-xl-0 gy-5">
                            ...
                            <div class="team-item-3 bg-white wow fade-in-bottom" data-wow-delay="200ms">
                                ...
                                <div class="team-content">
                                    ...
                                    <ul class="social-list">
                                        ...
                                        <li><a href="{{ $speaker->instagram }}" target="blank"><i class="fab fa-instagram"></i></a></li>
                                        @endif
                                        @if (!empty($speaker->linkedin))
                                        <li><a href="{{ $speaker->linkedin }}" target="blank"><i class="fab fa-linkedin"></i></a></li>
                                        @endif
                                        @if (!empty($speaker->twitter))
                                        <li><a href="{{ $speaker->twitter }}" target="blank"><i class="fab fa-twitter"></i></a></li>
                                        @endif
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="course-sidebar price-box event-sidebar">
                    <a href="contact.html" class="ed-primary-btn">Register</a>
                ...
                <div class="course-sidebar event-sidebar sticky-widget">
                    ...
                    <ul class="course-sidebar-list">
                        ...
                        <li><i class="fa-regular fa-phone"></i>Phone: <span><a href="tel:+25621522156">(+91) 901 9003 490</a></span></li>
                    </ul>
                </div>
            </div>
        </div>
