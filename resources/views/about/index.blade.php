    ...
    <div class="container">
        <div class="page-header-content">
            ...
            <h4 class="sub-title"><a class="home" href="{{ route('home') }}">Home </a><span class="icon">/</span>
                <a class="inner-page" href="{{ route('about') }}"> About Us</a></h4>
        </div>
    </div>
</section>
<!-- ./ page-header -->
                ...
                <div class="about-content">
                    ...
                    <div class="about-counter-items wow fade-in-bottom" data-wow-delay="600ms">
                        <div class="about-counter-item">
                            <div class="icon"><img src="{{ asset('ui/assets/img/icon/about-1.png') }}" alt="about"></div>
                            <div class="content">
                        ...
                        <div class="about-counter-item">
                            <div class="icon"><img src="{{ asset('ui/assets/img/icon/about-2.png') }}" alt="about"></div>
                            <div class="content">
        ...
        <div class="row gy-lg-0 gy-5">
            <div class="col-lg-4 col-md-6">
                <div class="about-feature-card">
                    <div class="icon"><img src="{{ asset('ui/assets/img/icon/about-feature-1.png') }}" alt="icon"></div>
                    <div class="content">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-item-3 team-item-5">
                    <div class="team-thumb">
                        <div class="shape"><img src="{{ asset('ui/assets/img/shapes/team-shape-3.png') }}" alt="team"></div>
                        <div class="team-men">
...
<section class="testimonial-section-3 pt-120 pb-120">
    <div class="shapes">
        <div class="shape shape-1"><img src="{{ asset('ui/assets/img/shapes/testi-shape-3.png') }}" alt="shape"></div>
        <div class="shape shape-2"><img src="{{ asset('ui/assets/img/shapes/testi-shape-4.png') }}" alt="shape"></div>
    </div>
    <div class="container">
                                ...
                                <div class="testi-item-3">
                                    ...
                                    <div class="testi-author">
                                        <div class="testi-author-img">
                                            <img src="{{ asset('ui/assets/img/images/testi-author-3.png') }}" alt="testi">
                                        </div>
